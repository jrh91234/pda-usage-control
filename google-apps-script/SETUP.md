...
เมื่อตั้งค่าแล้ว ทุกการเบิก/คืนจะเพิ่มแถวใน Transactions, อัปเดตสถานะ Devices, ลงทะเบียนผู้ใช้จากหน้า Admin และเก็บภาพยืนยันไว้ในโฟลเดอร์ Google Drive อัตโนมัติ.
